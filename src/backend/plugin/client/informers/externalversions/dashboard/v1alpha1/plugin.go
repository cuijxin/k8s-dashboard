...
import (
	...
	dashboardv1alpha1 "github.com/cuijxin/k8s-dashboard/src/backend/plugin/apis/dashboard/v1alpha1"
	versioned "github.com/cuijxin/k8s-dashboard/src/backend/plugin/client/clientset/versioned"
	...
	v1alpha1 "github.com/cuijxin/k8s-dashboard/src/backend/plugin/client/listers/dashboard/v1alpha1"
...
func (f *pluginInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dashboardv1alpha1.Plugin{}, f.defaultInformer)
}
