...
import (
	...
	v1alpha1 "github.com/cuijxin/k8s-dashboard/src/backend/plugin/apis/dashboard/v1alpha1"
	scheme "github.com/cuijxin/k8s-dashboard/src/backend/plugin/client/clientset/versioned/scheme"
