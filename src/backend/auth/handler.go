...
import (
	...
	"github.com/cuijxin/k8s-dashboard/src/backend/validation"
...
// Install creates new endpoints for dashboard auth, such as login. It allows user to log in to
// dashboard using one of supported methods. See AuthManager and Authenticator for more information.
