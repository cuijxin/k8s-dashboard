...
// To instantiate it use NewResourceController and pass object reference to it. It may be extended
// to provide more detailed set of functions.
type ResourceController interface {
	...
	// Returns all log sources of controlled resource (e.g. a list of containers and pods for
	// a replica set).
...
func NewResourceController(ref meta.OwnerReference,
	namespace string, client client.Interface) (ResourceController, error) {
...
// GetLogSources is an implementation of the GetLogSources method from ResoruceController interface
...
func (self PodController) GetLogSources(allPods []v1.Pod) LogSources {
	...
	return LogSources{
		...
		InitContainerNames: common.GetNonduplicateInitContainerImages(controlledPods),
	}
}
...
// It allows to provide custom set of functions for alerady existing type.
...
// StatefulSetController is an alias-type for Kubernetes API Stteful Set type. It allows to provide
// custom set of functions for already existing type.
type StatefulSetController apps.StatefulSet

// Get is an implementation of Get method from ResoruceController interface.
...
// GetLogSources is an implementation of the GetLogSources method from ResoureController interface.
