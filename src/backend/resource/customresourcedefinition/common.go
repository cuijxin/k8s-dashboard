...
import (
	...
	crdv1 "github.com/cuijxin/k8s-dashboard/src/backend/resource/customresourcedefinition/v1"
	crdv1beta1 "github.com/cuijxin/k8s-dashboard/src/backend/resource/customresourcedefinition/v1beta1"
...
func GetCustomResourceObjectList(client apiextensionsclientset.Interface,
	config *rest.Config,
...
func GetCustomResourceObjectDetail(client apiextensionsclientset.Interface,
	...
	config *rest.Config,
	crdName string,
	name string) (*types.CustomResourceObjectDetail, error) {
	version, err := GetExtensionsAPIVersion(client)
	if err != nil {
		return nil, err
	}
