...
func toCustomResourceDefinitionList(crds []apiextensionsv1.CustomResourceDefinition,
	nonCriticalErrors []error,
	dsQuery *dataselect.DataSelectQuery) *types.CustomResourceDefinitionList {
