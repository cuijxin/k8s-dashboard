...
// CustomResourceDefinitionList contains a list of Custom Resource Definitions
// in the cluster.
...
type CustomResourceDefinitionDetail struct {
	...
	Conditions   []common.Condition                `json:"coditions"`
	Objects      CustomResourceObjectList          `json:"objects"`
	Subresources []string                          `json:"subresources"`

	// List of non-criticalerrors， that occurred during resource retrieval.
	Errors []error `json:"errors"`
}
