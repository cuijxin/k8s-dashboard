...
// SettingsManager is uesed for user settings management.
type SettingsManager interface {
	...
	// DeletePinnedResoruce removes a pinned resource from config map.
...
type Settings struct {
	...
	DisableAccessDeniedNottifications bool     `json:"disableAccessDentiedNotifications"`
