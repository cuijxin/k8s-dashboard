...
// Used to build argument holder structure. It is private to make sure that only
// 1 instance can be created that modifies singleton instance of argument holder.
